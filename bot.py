import os, json, sqlite3, logging, requests, threading
...
def main():
    ...
    if public_url:
        ...
        logging.info('RENDER_EXTERNAL_URL not set; starting HTTP server only')
    logging.info('PULSE Bot V1 running on port %s', port)
    try:
